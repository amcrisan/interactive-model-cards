        ...
        if data_src == "From Training Data":
            ...
            with exp_lcol:
                ...
                user_text= placeholder.text_input(
                    ...
                    st.session_state['example_sent'][0]
                )
                ...
                #    "Write your own example sentences, or click 'Generate Examples Button'", "I like you. I love you.",
                #    key="user_text"
                #)
                #update the example
                #if st.button("See Model Prediction"):
                #    st.session_state['example_sent']= sample(set(sentence_examples['sentences']),1)
                if user_text !="":
                    ...
                    with st.form(key="my_form"):
                        ...
                        agreement = st.radio( "Indicate your agreement below", ["Agree", "Disagree"],0,key="radio")
            ...
            with exp_rcol:
                ...
                if not st.session_state['user_data'].empty:
                    ...
                    st.session_state['user_bench'].add_slices(dp,overwrite=True)
                    ...
                    chart = ut.visualize_metrics(st.session_state['user_bench'].metrics['model'])
